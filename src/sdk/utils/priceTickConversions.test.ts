import { Price, Token } from "../../sdk-core/index";
...
describe("priceTickConversions", () => {
  ...
  const token0 = token({ address: "2ouva-viaaa-aaaaq-aaamq-cai", sortOrder: 0 });
  const token1 = token({ address: "mxzaz-hqaaa-aaaar-qaada-cai", sortOrder: 1 });
  const token2_6decimals = token({ address: "zfcdd-tqaaa-aaaaq-aaaga-cai", sortOrder: 2, decimals: 6 });
